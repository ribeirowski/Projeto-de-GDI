...
-- CADASTRO DE PIRATAS QUE SÃO CAPITÃES:

EXEC CADASTRAR_PIRATA('003', 'RAFAEL', '01/01/1982', 'MOUNT GAY', 'C', NULL);
EXEC CADASTRAR_PIRATA('006', 'THIAGO', '25/04/2000', 'MONTILLA', 'C', NULL);
EXEC CADASTRAR_PIRATA('010', 'PERICLES', '31/08/1989', 'MONTILLA', 'C', NULL);
...
-- CADASTRO DE PIRATAS QUE SÃO TRIPULANTES:

EXEC CADASTRAR_PIRATA('001', 'LUIS', '17/10/1980', 'BACARDI', 'T', NULL);
EXEC CADASTRAR_PIRATA('002', 'JOAO VITOR', '19/02/2000', 'MONTILLA', 'T', '4000');
EXEC CADASTRAR_PIRATA('004', 'LIGIA', '18/11/2002', 'BACARDI', 'T', '3000');
EXEC CADASTRAR_PIRATA('005', 'LUCAS', '14/05/2001', 'MONTILLA', 'T', '3000');
EXEC CADASTRAR_PIRATA('007', 'VICTORIA', '21/11/2002', 'BACARDI', 'T', '3000');
EXEC CADASTRAR_PIRATA('008', 'MARIANA', '08/12/1979', 'MONTILLA', 'T', '7000');
EXEC CADASTRAR_PIRATA('009', 'NATHALIA', '15/01/2006', 'BACARDI', 'T', '7000');
