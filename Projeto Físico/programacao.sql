...
CREATE OR REPLACE PROCEDURE CADASTRAR_PIRATA (CPF_PIRATA VARCHAR2, NOME_PIRATA VARCHAR2, NASC_PIRATA DATE, RUM_FAV VARCHAR2, IS_CAP VARCHAR2, COD_NAVIO_P VARCHAR2) IS
