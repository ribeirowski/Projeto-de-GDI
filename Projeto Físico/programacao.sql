...
CREATE OR REPLACE PROCEDURE CADASTRAR_PIRATA (CPF_PIRATA VARCHAR2, NOME_PIRATA VARCHAR2, NASC_PIRATA DATE, RUM_FAV VARCHAR2, IS_CAP VARCHAR2) IS

BEGIN
    IF IS_CAP = 'C' OR IS_CAP = 'T' THEN
        INSERT INTO PIRATA VALUES (CPF_PIRATA, NOME_PIRATA, NASC_PIRATA, NULL, RUM_FAV);
        IF IS_CAP = 'C' THEN
            INSERT INTO CAPITAO VALUES (CPF_PIRATA);
            DBMS_OUTPUT.PUT_LINE ('CAPITÃO ' || NOME_PIRATA || ' CADASTRADO COM ÊXITO!');
        ELSIF IS_CAP = 'T' THEN
            INSERT INTO TRIPULANTE VALUES (CPF_PIRATA);
